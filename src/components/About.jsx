...
const About = () => {
    return (
        <div className='lg:w-3/4 flex flex-col justify-center items-center mx-auto lg:gap-10  mt-14 lg:mt-24 px-4'>
            <h3 className='font-primary text-primary text-[35px] '>About us</h3>
            <div className='flex flex-col justify-center gap-8'>
                <h3 className='font-secondary text-secondary text-[20px] lg:text-[40px] text-justify tracking-wide '>
